...
const panelEl = document.getElementById("buildingPanel") as HTMLElement;
const panelTitleEl = document.getElementById("panelTitle") as HTMLElement;
const panelLevelEl = document.getElementById("panelLevel") as HTMLElement;
const panelDescEl = document.getElementById("panelDesc") as HTMLElement;
const panelProductionEl = document.getElementById("panelProduction") as HTMLElement;
const panelCostEl = document.getElementById("panelCost") as HTMLElement;
const panelRulesEl = document.getElementById("panelRules") as HTMLElement;
const panelActionEl = document.getElementById("panelAction") as HTMLButtonElement;
const panelCloseEl = document.getElementById("panelClose") as HTMLButtonElement;
const statusLineEl = document.getElementById("statusLine") as HTMLElement;
const heroLevelEl = document.getElementById("heroLevel") as HTMLElement;
const heroPowerEl = document.getElementById("heroPower") as HTMLElement;
const resourceBarEl = document.getElementById("resourceBar") as HTMLElement;
const collectAllBtnEl = document.getElementById("collectAllBtn") as HTMLButtonElement | null;
const template = document.getElementById("buildingTemplate") as HTMLTemplateElement;
...
function renderPanel() {
  ...
  if (building.productionPerLevel) {
    ...
    if (level > 0) {
      ...
      currentRateChip.textContent = `Current +${(Number(amount) * level).toFixed(1).replace(".0", "")}/s`;
    ...
    nextRateChip.textContent = `After +${(Number(amount) * (level + 1)).toFixed(1).replace(".0", "")}/s`;
...
function buildMapNodes() {
  ...
  for (const building of BUILDINGS) {
    ...
    const buildingButton = node.querySelector(".building") as HTMLButtonElement;
    const collectButton = node.querySelector(".collect-btn") as HTMLButtonElement;
    const timerLabel = node.querySelector(".upgrade-timer") as HTMLElement;
    const badgeEl = node.querySelector(".building-badge") as HTMLElement;
    const spriteEl = node.querySelector(".building-sprite") as HTMLImageElement;
    const placeholderEl = node.querySelector(".building-placeholder") as HTMLElement;
